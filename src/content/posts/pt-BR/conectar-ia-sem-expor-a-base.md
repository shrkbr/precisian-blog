...
Vale dizer que nenhuma dessas camadas é exótica. Papel de banco dedicado, política de linha e registro de consulta são práticas que qualquer time de infraestrutura já conhece; o que mudou foi quem está do outro lado da conexão. A novidade não é a técnica de contenção, é o fato de o consumidor ser um sistema que obedece a instruções que encontra no caminho.
